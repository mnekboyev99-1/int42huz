...
const SENTRY_DSN = process.env.NEXT_PUBLIC_INT42H_SENTRY_DSN || process.env.INT42H_SENTRY_DSN;
const INT42H_ENV = process.env.NEXT_PUBLIC_INT42H_ENV || process.env.INT42H_ENV || "dev";
