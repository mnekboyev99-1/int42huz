        ...
        <GeneralWrapperStyled>
          <div className="flex flex-col space-y-2 mb-2">
            <div className="flex items-center justify-between">
              <TypeOfContentTitle title={t('playgrounds.playgrounds') || 'Playgrounds'} type="pg" />
              {isUserAdmin && (
                <button
              ...
              <div className="flex items-center gap-3 mb-4 flex-wrap">
                <div className="relative w-full sm:w-80">
                  ...
                  <input
                    ...
                    aria-label={t('playgrounds.search_placeholder') || 'Search playgrounds...'}
            ...
            {searchQuery && (
              <div className="mb-2 text-sm text-gray-500">
                {t('pagination.results', { count: filtered.length, query: searchQuery }) || `${filtered.length} results for "${searchQuery}"`}
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              {playgrounds.length === 0 && !searchQuery && (
                <div className="col-span-full flex flex-col justify-center items-center py-12 px-4 border-2 border-dashed border-gray-100 rounded-2xl bg-gray-50/30">
                  ...
                  <h1 className="text-xl font-bold text-gray-600 mb-2">{t('playgrounds.no_playgrounds_yet') || 'No playgrounds yet'}</h1>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm" onClick={() => setShowNameModal(false)}>
        <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm mx-4" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex gap-2 justify-end">
            ...
            >
              {isCreating ? (t('common.creating') || 'Creating…') : (t('common.save') || 'Create')}
            </button>
          </div>
        </div>
      </div>
