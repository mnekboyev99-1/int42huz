...
import { getINT42H_TOP_DOMAIN_VAL, getINT42H_TELEMETRY_DISABLED_VAL } from '@services/config/config'
import Script from 'next/script'
import Providers from '@components/Providers'
import { Wix_Madefor_Text } from 'next/font/google'

const isDevEnv = getINT42H_TOP_DOMAIN_VAL() === 'localhost'
const isTelemetryDisabled = getINT42H_TELEMETRY_DISABLED_VAL() === 'true'
...
export default function RootLayout({
  ...
  return (
    <html className={wixMadeforText.variable} lang="uz" suppressHydrationWarning>
      <head>
