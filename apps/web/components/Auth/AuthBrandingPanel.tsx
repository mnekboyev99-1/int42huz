...
import Int42hIcon from 'public/int42h_bigicon_1.png'
...
export default function AuthBrandingPanel({ org, welcomeText }: AuthBrandingPanelProps) {
  ...
  // Check if org has enterprise plan - hide Int42h branding for enterprise users
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full p-10">
        {/* Top bar with Int42h lrn.svg logo - hidden for enterprise users */}
        {!isEnterprise && (
          <div className="login-topbar">
            <Link prefetch href="https://int42h.uz" target="_blank">
              <img
                src="/lrn.svg"
                alt="Int42h"
                width={30}
