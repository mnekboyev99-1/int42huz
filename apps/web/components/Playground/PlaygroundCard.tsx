...
const accessConfig = {
  public: { icon: Globe, labelKey: 'playgrounds.access.public', defaultLabel: 'Public', className: 'bg-green-100 text-green-700' },
  authenticated: { icon: Lock, labelKey: 'playgrounds.access.members', defaultLabel: 'Members', className: 'bg-blue-100 text-blue-700' },
  restricted: { icon: Users, labelKey: 'playgrounds.access.restricted', defaultLabel: 'Restricted', className: 'bg-amber-100 text-amber-700' },
}
...
export default function PlaygroundCard({ playground, orgslug, canEdit }: PlaygroundCardProps) {
  ...
  const accessLabel = t(access.labelKey) || access.defaultLabel
