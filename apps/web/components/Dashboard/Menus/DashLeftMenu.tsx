...
function DashLeftMenu() {
  ...
  const planLabel =
    mode === 'ee' ? (t('common.plans.enterprise_edition') || 'Enterprise Edition') :
    mode === 'oss' ? 'OSS' :
    plan === 'enterprise' ? t('common.plans.enterprise') :
    plan === 'pro' ? t('common.plans.pro') :
    plan === 'standard' ? t('common.plans.standard') :
          ...
          <div className="space-y-1">
            ...
            {showPlaygrounds && (
              <MenuLink
                ...
                label={t('common.playgrounds') || 'Playgrounds'}
                isCollapsed={isCollapsed}
            ...
            <HoverMenu
              content={
                <HoverMenuContent className="w-64">
                  <HoverMenuLabel className="text-white/70 font-medium">{t('common.analytics') || 'Analytics'}</HoverMenuLabel>
                  <HoverMenuSeparator />
                  <HoverMenuItem asChild>
              ...
              {(() => {
                ...
                return (
                  ...
                  >
                    ...
                    {!isCollapsed && (
                      <>
                        <span className="text-sm font-medium flex-1 text-left">{t('common.analytics') || 'Analytics'}</span>
                        <CaretDown aria-hidden="true" size={14} weight="bold" className={active ? "text-white/70" : "text-white/40"} />
                      </>
                    )}
                  </Link>
            ...
            {(!showCommunities || !showPodcasts || !showBoards || !showPlaygrounds || !showPayments) && (
                  ...
                  <HoverMenuContent className="w-64">
                    <HoverMenuLabel className="flex items-center justify-between text-white/70 font-medium">
                      ...
                      <span className="text-[9px] font-medium uppercase tracking-wider px-1.5 py-0.5 rounded bg-white/[0.06] text-white/25">
                        {t('common.features.disabled.status') || 'Disabled'}
                      </span>
                    </HoverMenuLabel>
                    <HoverMenuSeparator />
                    {!showCommunities && (
              ...
              >
                ...
                >
                  ...
                  {!isCollapsed && (
                    <>
                      <span className="text-sm font-medium flex-1 text-left">{t('common.other') || 'Other'}</span>
