                        ...
                        return (
                            <div key={role.id} className="bg-white border border-gray-200 rounded-lg p-4 space-y-3 shadow-sm">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span className="font-medium text-sm">
                                            {isSystem 
                                                ? t(`roles.role_${role.name.toLowerCase()}`) 
                                                : role.name}
                                        </span>
                                        {isSystem && (
                                ...
                                <p className="text-gray-600 text-sm">
                                    {isSystem 
                                        ? t(`roles.role_${role.name.toLowerCase()}_desc`) 
                                        : (role.description || t('dashboard.users.roles.no_description'))}
                                </p>
                                <div className="flex space-x-2">
                                    <Modal
                                        ...
                                        dialogTitle={t('dashboard.users.roles.modals.view_rights.title', { 
                                             roleName: isSystem 
                                                 ? t(`roles.role_${role.name.toLowerCase()}`) 
                                                 : role.name 
                                         })}
