...
const OrgEditAutomations: React.FC = () => {
  ...
  return (
    ...
    >
      <>
        {/* ── Zapier hero card (hidden until the Int42h Zapier app is live) ────────────────────── */}
        {false && (
          ...
          <div className="px-5 py-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-500 text-xs mt-0.5">
                Connect Int42h to thousands of apps without writing code.
              </p>
            </div>
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <a
                href="https://zapier.com/apps/int42h/integrations"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
...
// Zapier-managed webhooks are read-only from Int42h's side — the Zap itself
