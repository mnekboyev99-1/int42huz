...
import React, { createContext, useContext, useEffect, useReducer, useMemo, useCallback, useRef, useState } from 'react'
...
export function CourseProvider({
  ...
  const swrKey = (session?.status !== 'loading' || hasResolvedSession)
