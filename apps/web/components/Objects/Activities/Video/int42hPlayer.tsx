...
const Int42hPlayer: React.FC<Int42hPlayerProps> = ({
  src,
  details,
  onReady,
  poster,
  ...
  return (
    <div
      ref={containerRef}
      className={`int42h-player relative w-full aspect-video overflow-hidden bg-black ${
