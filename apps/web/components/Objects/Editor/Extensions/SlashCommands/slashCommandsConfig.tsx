...
export const slashCommands: SlashCommandItem[] = [
  ...
  {
    id: 'slider',
    title: 'Slayder (Rasmlar)',
    description: 'Ko\'p rasm yuklash va slayd qilib ko\'rsatish',
    icon: <Images size={18} />,
    category: 'media',
    keywords: ['slider', 'carousel', 'slayd', 'rasmlar'],
    command: (editor) => {
      editor.chain().focus().insertContent({ type: 'blockSlider' }).run()
    },
  },
  {
    id: 'video',
  ...
  },
  {
    ...
    category: 'media',
    keywords: ['attachment', 'file', 'upload', 'zip', 'doc', 'excel', 'rar'],
    command: (editor) => {
      editor.chain().focus().insertContent({ type: 'blockAttachment' }).run()
    },
  },
