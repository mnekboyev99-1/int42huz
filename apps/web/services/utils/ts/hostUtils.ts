 ...
 * isSubdomainOf("acme.int42h.io:3000", "int42h.io") -> true
 * isSubdomainOf("int42h.io", "int42h.io") -> false (same host, not a subdomain)
 */
 ...
 * Both may include ports — ports are stripped before comparison.
 * extractSubdomain("acme.int42h.io:3000", "int42h.io") -> "acme"
 * extractSubdomain("int42h.io", "int42h.io") -> null
 * extractSubdomain("localhost", "int42h.io") -> null
 */
