...
let SENTRY_DSN = process.env.NEXT_PUBLIC_INT42H_SENTRY_DSN;
let INT42H_ENV = process.env.NEXT_PUBLIC_INT42H_ENV || "dev";
  ...
  for (const configPath of possiblePaths) {
    try {
      if (fs.existsSync(configPath)) {
        ...
        SENTRY_DSN = rc.NEXT_PUBLIC_INT42H_SENTRY_DSN || SENTRY_DSN;
        INT42H_ENV = rc.NEXT_PUBLIC_INT42H_ENV || INT42H_ENV;
        break;
      }
    } catch {
