          ...
          nestedIframes?.forEach((nestedIframe: HTMLIFrameElement) => {
            try {
              if (nestedIframe.contentDocument) {
                ...
                nestedStyle.id = 'int42h-scorm-styles'
                ...
                `
                // Remove any existing int42h styles first
                const existing = nestedIframe.contentDocument.getElementById('int42h-scorm-styles')
