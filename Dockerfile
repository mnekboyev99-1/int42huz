...
ARG INT42H_PUBLIC=false
RUN if [ "$INT42H_PUBLIC" = "true" ]; then rm -rf /app/api/ee; fi
...
ENV PORT=8000 INT42H_PORT=9000 COLLAB_PORT=4000 HOSTNAME=0.0.0.0 INT42H_OSS=true NEXT_PUBLIC_INT42H_OSS=true
